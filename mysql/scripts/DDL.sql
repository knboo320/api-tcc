...
CREATE TABLE IF NOT EXISTS `quirinos_db`.`servicos` (
  ...
  `status` VARCHAR(10) NULL DEFAULT 'Pendente',
  PRIMARY KEY (`id_servico`, `id_cliente`),
  INDEX `fk_servicos_funcionarios1_idx` (`id_funcionario` ASC) VISIBLE,
  INDEX `fk_servicos_clientes1_idx` (`id_cliente` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `quirinos_db`.`imagens_servico` (
  ...
  INDEX `fk_imagens_servico_servicos1_idx` (`id_servico` ASC) VISIBLE,
